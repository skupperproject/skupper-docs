...
If you want to limit link creation to be a specific interface, for example to an interface associated with the IP address 192.168.1.10:

[source, bash]
----
$ skupper init --ingress-host 192.168.1.10
----
