...
You can also specify the ingress hostname using the `--ingress-host` option.

[NOTE]
====
When creating tokens you can specify a name, which you can later use to identify a particular token.
For example:

[source, bash]
----
$ skupper create --name my-token
----
====
--
