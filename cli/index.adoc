...
If you install a Skupper policy as described in xref:policy:index.adoc[], the message becomes `Skupper is enabled for namespace "west" in interior mode (with policies)`.
