...
**📌 NOTE**
These resources are **internal-only**. They are managed directly by the Skupper controller and are subject to change without notice in future versions of Skupper. Do not modify, delete, or build automation that depends on the state or existence of these resources. 
