...
:ConsoleLink: link:{linkroot}console/index.html[Using the Skupper console]
...
:Policylink: link:{linkroot}policy/index.html[Securing a service network using policies]