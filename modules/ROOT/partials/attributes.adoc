...
// URLs
:GettingStartedLink: link:https://skupper.io/start/[Getting started]
...
:Declarativelink: link:{linkroot}declarative[Configuring Skupper sites using YAML]
:Clilink: link:{linkroot}cli/[Configuring Skupper sites using the CLI]
:Consolelink: link:{linkroot}console/[Monitoring Skupper sites using the console]
