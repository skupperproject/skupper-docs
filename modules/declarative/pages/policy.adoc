...
For example, the following policy CR disallows outgoing links for all namespaces and only permits service bindings named `deployment/nginx`, but all other {skupper-name} capabilities are allowed:
