...
+
----
$ kubectl get secret skupper-console-users -o yaml| grep admin
...
The {skupper-name} console allows you create and use claim type tokens as described in {SkupperCliBookLink}.
