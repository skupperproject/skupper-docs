...
NOTE: To display components that require services rather than provide services, the flow-collector makes all services that are available in the namespace visible in the console.
