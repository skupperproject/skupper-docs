...
There might be many replicas associated with an address, these are shown in the Skupper console as _processes_. 
...
In the console, both are shown so that you can view the traffic and called _components_.
