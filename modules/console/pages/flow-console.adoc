...
. Click *Addresses* and choose an address to show the details for that address. This shows the set of processes that are exposed across the {service-network}.
