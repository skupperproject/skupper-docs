...
----
+
IMPORTANT: You must enable the console on the same site as you enable the flow collector.
...
. Check the *Sites* tab, all your sites should be listed.
...
. Click an address to show the details for that address.
