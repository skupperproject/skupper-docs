...
If you encounter network performance issues, you can scale Skupper to address those concerns.
For example, use this procedure to increase network throughput, and if you have many clients, network latency.
...
----
+
As an alternative, you can create a new namespace and configure that for network performance testing before deleting your original site.

. Recreate the site with optimal performance CPU settings:
+
----
