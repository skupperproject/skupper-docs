...
----
The output shows the linking of sites and exposing a service on a {service-network}.
...
See xref:console:index.adoc[] for more information about *Accessing the console*, including how to retrieve the username and password.
