...
[role="system:abstract"]
Creating claim tokens allows you to restrict access to the {service-network}
...
[role="system:abstract"]
Creating cert tokens allows you create many links to the {service-network} from different sites without restrictions.
...
NOTE: Cert tokens are always valid, and can be reused indefinitely.
--
