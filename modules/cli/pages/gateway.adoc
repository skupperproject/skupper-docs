...
bindings.service.exposeIngress:: (optional) The ingress mode for the service.
...
bindings.service.publishnotreadyaddresses:: Specify whether to sync services relating to Kubernetes objects scheduled but not yet available.
