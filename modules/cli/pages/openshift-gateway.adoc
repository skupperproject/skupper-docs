 ...
 * Running on all addresses.
   WARNING: This is a development server. Do not use it in a production deployment.
 * Running on http://10.33.241.56:8080/ (Press CTRL+C to quit)
----

Note the IP address as <backend-ip-address>
--
...
[source,bash,term=local]
----
http://<backend-ip-address>:8080/api/hello
----
...
----
Gateway Definitions:
╰─ <machine>-<user> type: podman version: 1.17.1 url: amqp://127.0.0.1:5672
 ╰─ Bindings:
