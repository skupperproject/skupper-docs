...
// Type: procedure
[id="exposing-services-proxy"] 
== Exposing a local service to the {service-network}

This section shows how to expose a service running locally on a {service-network}.
...
--
----
$ skupper proxy expose <service> localhost <port>
----
...
----
$ skupper proxy expose mysql 192.168.1.200 3306

Skupper proxy proxy1 created
----
====
--

. Check the status of Skupper proxies:
+
--
----
$ ./skupper proxy status
Proxy Definitions Summary

NAME    BINDS  FORWARDS  URL                    
proxy1  1      0         amqp://127.0.0.1:5672 
----
