...
* When there are a number of paths from a client to a server, traffic flows on the lowest cost path until the number of connections exceeds the cost of an alternative path.
