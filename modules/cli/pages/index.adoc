...
By default, services exposed on a site in a cluster may become accessible on all namespaces on a remote cluster which has a site initialized. 
This setting restricts service access to the namespace in which the site was created.
