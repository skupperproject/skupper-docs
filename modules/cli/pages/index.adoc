...
[subs=attributes+]
----
$ curl -fL https://github.com/skupperproject/skupper/releases/download/0.4.2/skupper-cli-0.4.2-linux-amd64.tgz | tar -xzf -
----

For MacOS:
[subs=attributes+]
----
$ curl -fL https://github.com/skupperproject/skupper/releases/download/0.4.2/skupper-cli-0.4.2-mac-amd64.tgz | tar -xzf -
----
--
