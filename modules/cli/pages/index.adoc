...
NOTE: You can specify more than one port by repeatinging this option.
...
include::gateway-download.adoc[]

include::{common}network-status.adoc[leveloffset=+1]

include::{common}protocols.adoc[leveloffset=+1]
