...
// Type: procedure
[id="customizing-using-cli"] 
== Customizing a site using the CLI

If you require a custom configuration, you might need to recreate the site.

.Procedure


. Create a site without a console:
+
----
$ skupper delete
...
----
+
NOTE: If you have linked to sites, you need to recreate those links after reinitializing the site.

. Configure the {skupper-name} console protection.
