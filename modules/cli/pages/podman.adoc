...
If you are using CNI, for example, if you upgrade from Podman v3, you must also install https://www.cni.dev/plugins/current/[containernetworking-plugins].
For example, `dnf install containernetworking-plugins` or `apt-get install containernetworking-plugins`.
--
